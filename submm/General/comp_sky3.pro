...
set_plot,'ps'
device,filename='/home/chyan/Thesis/Latex/alma_sma_compare_sky3a.eps'$
...
plot,[1,1d4],[1,1d4],/nodata,/xlog,/ylog,yrange=[1,1d4],xrange=[1,1d3],xstyle=1$
	...
	,ytitle='Total detected counts (n)',xcharsize=1.5,ycharsize=1.5
;---------------------------------------
;  SMA
;---------------------------------------
t=findgen(t_total)+1
...
xyouts,1.3,900,'ALMA',charsize=1.3
;---------------------------------
; SCUBA
;---------------------------------
...
xyouts,1.3,50,'SCUBA+',charsize=1.3
;-------------------------------------------------
; Bolocam
;-------------------------------------------------
...
xyouts,1.3,90,'BOLOCAM/LMT(1.2mm)',charsize=1.3
;----------------------------------
; SCUBA2
;----------------------------------
...
xyouts,1.5,3000,'SCUBA-2',charsize=1.3
...
;device,/close
;-------------------------------------------------------------------
;device,filename='/home/chyan/Thesis/Latex/alma_sma_compare_2_sky3.eps'$
;	,/encapsulated
device,filename='/home/chyan/Thesis/Latex/alma_sma_compare_sky3b.eps'$
	,/encapsulated,xsize=20,ysize=20

plot,ct_sma,ds_sma,/xlog,/ylog,xrange=[0.1,1d5],yrange=[0.001,1d2]$,
	,xtitle='!6Source counts (n)',ystyle=1$
	,ytitle='Sensitivity (mJy)',xcharsize=1.5,ycharsize=1.5
index=[0,49,199,499,999]
oplot,ct_sma(index),ds_sma(index),psym=4
xyouts,ct_sma(index(4))-1.5,ds_sma(index(4)),'SMA',charsize=1.3

oplot,ct_alma,ds_alma
oplot,ct_alma(index),ds_alma(index),psym=4
xyouts,ct_alma(index(2))-20,ds_alma(index(2)),'ALMA',charsize=1.3
