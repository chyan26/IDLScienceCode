...
set_plot,'ps'
device,filename='/home/chyan/Thesis/Latex/sma_sky1_err.eps',$
...
plot,s,n,/xlog,/ylog,thick=5,xstyle=1,xtitle='!6Flux (mJy)'$
	,ytitle='Source counts (per square degree)',charsize=2.0
oplot,s,n+nerr
oplot,s,n-nerr

sma_constrain_sky1,1000,20,cs,cn,cerr,a,err
