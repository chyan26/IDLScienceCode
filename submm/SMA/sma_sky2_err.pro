PRO sma_sky2_err
set_plot,'ps'
device,filename='/home/chyan/Thesis/Latex/sma_sky2_err.eps',$
	/encapsulated,xsize=20,ysize=20

s=series(0.28,10,2000)
n=sky2_sn(10,2000)
plot,s,n,/xlog,/ylog,ystyle=1,thick=5,xstyle=1,xtitle='!6Flux (mJy)'$
	,ytitle='Source counts (per square degree)',charsize=1.5
...
sma_constrain_sky2,1000,90,ss,no,err,a0,da0,a1,da1,a,da,b,db,fp
...
PRO sma_constrain_sky2,total_t,obs_t,ss,no,err,a_0,da_0,a_1,da_1,alpha,dalpha,beta,dbeta,fp
