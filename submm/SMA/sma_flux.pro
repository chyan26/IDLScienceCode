...
position2=[0.1,0.05,0.95,0.45]
plot,s,n,/xlog,/ylog,position=position1
...
case !version.os_family of
	'unix' : rootdir='/scr1/SMA/'
	'Windows':rootdir='c:\chyan\SMA'
endcase

prefix1=filepath('submm_source',root=rootdir, subdir='Data')
prefix2=filepath('submm_position',root=rootdir, subdir='Data')
prefix3=filepath('submm_radec',root=rootdir, subdir='Data')
prefix4=filepath('bg_soure',root=rootdir, subdir='Background')
prefix5=filepath('bg_position',root=rootdir, subdir='Background')
...
;window,1
;wset,1
plot,data(1,*),data(2,*),psym=3,xstyle=1,ystyle=1,position=position2,noerase=1
