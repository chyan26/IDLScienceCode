...
obs_region=10
bk_region=2
fov=18             ; FOV is 36 arcsecond for SMA, 18 for ALMA
...
PRO RANDOM_REGION, DATA, FOV, RA, DEC, NAME1, NAME2, NAME3
	...
	NAME3=name3
	jump1:
	random=3600*randomu(seed1,500)
	x_center=random(fix(500*randomu(seed1,1)))
	y_center=random(1)

	;x_center=3600*randomu(seed,1)
	;y_center=3600*randomu(seed,1)
