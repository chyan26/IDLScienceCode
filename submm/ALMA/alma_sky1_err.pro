...
set_plot,'ps'
device,filename='/home/chyan/Thesis/Latex/alma_sky1_err.eps',$
...
plot,s,n,/xlog,/ylog,thick=5,xstyle=1,xtitle='!6Flux (mJy)',charsize=2.0$
	,ytitle='Source counts (per square degree)'
oplot,s,n+nerr
oplot,s,n-nerr

alma_constrain_sky1,1000,20,cs,cn,cerr,a,err
...
PRO alma_constrain_sky1,total_t,obs_t,ss,no,err,parameter,error
