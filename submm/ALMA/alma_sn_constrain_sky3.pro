PRO ALMA_SN_CONSTRAIN_SKY3
	...
	device,filename='/home/chyan/Thesis/Latex/alma_sn_constrain_'+$
		strcompress(string(total_t),/remov)+'hr_sky3.eps',/encapsulated,$
		xsize=30,ysize=15


	for i=0,n_elements(t)-1 do begin
		alma_constrain_sky2,total_t,t(i),a,b,error_a,error_b
		alpha(i)=-a
		beta(i)=-b
		err_a(i)=error_a
		err_b(i)=error_b
...
PRO alma_constrain_sky3,total_t,obs_t,alpha,beta,error_a,error_b,fp
	...
	;if sig*ds(1) lt 0.23 then flux=0.23
	...
	;oplot,ll,exp(rr[0])*ll^rr[1]
	;oplot,l2,exp(r2[0])*l2^r2[1]
