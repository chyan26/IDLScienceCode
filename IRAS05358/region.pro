...
PRO RESIZEIMAGE, image, header
	...
	im3=readfits(path+'S233IR_H2_coadd.fits',hd3)
...
PRO SAVEFITS, image, header
	...
	writefits,imgpath+'s233ir_j_1.fits',image.j,header.j
	writefits,imgpath+'s233ir_h_1.fits',image.h,header.h
	writefits,imgpath+'s233ir_h2_1.fits',image.h2,header.h2
...
PRO DOSTIFF
	...
	cd,imgpath
	spawn, 'stiff -c stiff.conf s233ir_h2_1.fits s233ir_h_1.fits '+$
		's233ir_j_1.fits -GAMMA 1.7 -COLOUR_SAT 1.2 -MIN_LEVEL '+$
		'0.01 -MAX_LEVEL 0.995'
END
