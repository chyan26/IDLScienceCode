...
PRO SAVELINEIMG, line, header
   ...
   writefits,imgpath+'line_brg.fits',line.brg,header.brg
   writefits,imgpath+'line_h2.fits',line.h2,header.h2
   writefits,imgpath+'line_mask.fits',line.mask,header.brg
...
PRO CLUMPTABLE
   ...
   for k=0,n_elements(table)-1 do begin
      readcol,imgpath+table[k]+'.txt',id,x,y,fmax,sizex,sizey,r,flux,npix,/silent
      hd=headfits(imgpath+fits[k]+'.fits')
      xyad,hd,x,y,ra,dec
...
PRO SUBTRACT_CONT, im, line
   ...
   nm=fltarr(1024,1024)
   nm[*,*]=1
   spawn,"wircampolyregion "+'sw_brightstar.reg'+" /tmp/region.txt"
...
PRO LOADLINE, image, header
   ...
   nim1=readfits(imgpath+'line_h2.fits',nhd1)
   nim2=readfits(imgpath+'line_brg.fits',nhd2)
   nim3=readfits(imgpath+'line_mask.fits',nhd3)
...
PRO CUTREGION, im, hd
   ...
   savesubregion,hd.h2,im.h2,461,561,461,561,'h2_central.fits'
   savesubregion,hd.h2,im.h2,450,650,550,750,'h2_reg1.fits'
   savesubregion,hd.h2,im.h2,535,665,500,630,'h2_reg2.fits'
   savesubregion,hd.h2,im.h2,510,610,390,490,'h2_reg3.fits'
   savesubregion,hd.h2,im.h2,560,710,310,460,'h2_reg4.fits'
   savesubregion,hd.h2,im.h2,640,740,440,540,'h2_reg5.fits'
   savesubregion,hd.h2,im.h2,415,525,210,320,'h2_reg6.fits'
   savesubregion,hd.h2,im.h2,300,400,890,990,'h2_reg7.fits'
   savesubregion,hd.h2,im.h2,500,600,160,260,'h2_reg8.fits'   
   savesubregion,hd.h2,im.h2,630,760,670,800,'h2_reg9.fits'
