...
set_plot,'ps'
device,filename=home+'051202_zipF068001_B0560.ps',xsize=20,$
       ysize=20,yoffset=5,xoffset=0

im=readfits(home+'051202_zipF068001_B0560.fit')
