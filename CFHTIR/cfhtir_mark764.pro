...
PRO cfhtir_stack_mark764, FILE=file, STACK=stack
	...
	th_image_cont,im1,/nocont,crange=[0,1000]
	print,'Click on AGN...'
	cursor,x,y,/down
...
PRO CFHTIR_MARK764
	...
	;cfhtir_buildsky, file=list, sky='sky_mark764_20060108.fits'
	
	cfhtir_doreduc, file = list, dark = calibpath+'dark_60s_20051221.fits',$
		 flat=calibpath+'domeflat_j_20051221.fits', sky='sky_mark764_20060108.fits',$
		 badpix=calibpath+'badpix_20051223.fits',bias=1000,/invertew
	
	cfhtir_stack_mark764, file = list, stack='mark764.fits'
