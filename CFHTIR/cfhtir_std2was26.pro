...
PRO CFHTIR_STD2WAS26
	...
	cfhtir_doreduc, file = list, dark = calibpath+'dark_20s_20051221.fits',$
		 flat=calibpath+'domeflat_j_20051221.fits', sky='sky_std2was26_20060302.fits',$
		 badpix=calibpath+'badpix_20051223.fits',bias=1000,/invertew
	
	cfhtir_stack_stdwas26, file = list, stack='std2_was26.fits'
