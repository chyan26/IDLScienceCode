PRO cfhtir_stack_mcg2, FILE=file, STACK=stack
	...
	for i=1,n_elements(filelist)-1 do begin
		...
		th_image_cont,im2,/nocont,crange=[0,7000]
		cursor,a,b,/down
...
PRO CFHTIR_mcg2
	...
	;cfhtir_doreduc, file = list, dark = calibpath+'dark_60s_20051221.fits',$
	;	 flat=calibpath+'domeflat_j_20051221.fits', sky='sky_mcg2_20060302.fits',$
	;	 badpix=calibpath+'badpix_20051223.fits',bias=1000,/invertew
	
	cfhtir_stack_mcg2, file = list, stack='mcg2.fits'
