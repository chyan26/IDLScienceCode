PRO cfhtir_stack_stdpg0844, FILE=file, STACK=stack
...
PRO CFHTIR_STDPG0844
	...
	;cfhtir_doreduc, file = list, dark = calibpath+'dark_60s_20051221.fits',$
	;	 flat=calibpath+'domeflat_j_20051221.fits', sky='sky_rxsj15186_20060302.fits',$
	;	 badpix=calibpath+'badpix_20051223.fits',bias=1000,/invertew
	
	cfhtir_stack_stdpg0844, file = list, stack='std_pg0844.fits'
